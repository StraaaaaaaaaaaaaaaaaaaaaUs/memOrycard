...
questions_list.append(Question('Сколько граней у куба', '6', 'да', '12', '8'))
 
app = QApplication([])
 
app.setWindowIcon(QtGui.QIcon('test icon2.ico'))
...
#  
window.setWindowIcon(QtGui.QIcon('test icon2.ico'))
next_question()
